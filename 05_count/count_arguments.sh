############ sample_arguments.sh ############
#Sample arguments file for squire count
...
tempfolder=/scratch/qtbui_TE/05_count/tmp
...
count_folder=/scratch/qtbui_TE/05_count/out
